...
- [6. ARIMA模型](02-预测类算法说明.md) — 灰色预测适合小样本, ARIMA需要大样本
- [2. 插值与拟合](02-预测类算法说明.md) — 灰色预测也可视为一种拟合方法
...
<!-- EVOLVED: verified 2026-05-11 curve_fit -->
...
- [3. 线性回归](02-预测类算法说明.md) — 拟合的特例 — 最小二乘
- [1. 灰色预测模型](02-预测类算法说明.md) — 对比数据拟合和灰色建模
...
- [2. 插值与拟合](02-预测类算法说明.md) — 线性回归是最简单的拟合
- 逻辑回归 — 线性回归 vs 分类回归
...
- [5. 支持向量机](02-预测类算法说明.md) — NN vs SVM 对比非线性建模
- [1. 随机森林](07-机器学习算法说明.md) — 深度学习 vs 集成学习
...
- [4. 神经网络](02-预测类算法说明.md) — SVM理论保证 vs NN黑盒
- 逻辑回归 — SVM分类 vs 逻辑回归分类
...
- [1. 灰色预测模型](02-预测类算法说明.md) — ARIMAvs灰色预测适用场景
- [7. 指数平滑法](02-预测类算法说明.md) — 同属时间序列方法
...
- [6. ARIMA模型](02-预测类算法说明.md) — 指数平滑是ARIMA的特例
- [8. Prophet预测模型](02-预测类算法说明.md) — 对比传统和现代预测
...
- [6. ARIMA模型](02-预测类算法说明.md) — Prophet vs ARIMA — 实用性对比
- [7. 指数平滑法](02-预测类算法说明.md) — Prophet的自动趋势检测
...
## scipy.optimize.least_squares (进化发现)

- **题型**: regression
- **最近验证**: 2026-05-10 21:01
- **验证结果**: PASS
- *此算法由进化引擎自动补充*

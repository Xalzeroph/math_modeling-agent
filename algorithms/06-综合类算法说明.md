...
- [6. 模拟退火算法](01-优化算法说明.md) — SA的Metropolis准则来自MC
- [2. 排队论](06-综合类算法说明.md) — 排队系统的MC仿真
...
- [1. 蒙特卡洛模拟](06-综合类算法说明.md) — 排队系统的MC仿真
- [5. 马尔科夫链](06-综合类算法说明.md) — M/M/1队列是生灭过程
...
- [1. 线性规划](01-优化算法说明.md) — 零和博弈等价于LP
- [14. 多目标优化](01-优化算法说明.md) — 博弈均衡 vs Pareto最优
...
- [5. 马尔科夫链](06-综合类算法说明.md) — CA的局部规则 vs MC的状态转移
- [6. 微分方程建模](06-综合类算法说明.md) — CA是PDE的离散近似
...
- [1. 蒙特卡洛模拟](06-综合类算法说明.md) — MCMC是MC的扩展
- [2. 排队论](06-综合类算法说明.md) — 排队系统的生灭过程
...
- [1. 蒙特卡洛模拟](06-综合类算法说明.md) — ODE数值解的MC方法
- [2. 排队论](06-综合类算法说明.md) — 排队系统的ODE模型

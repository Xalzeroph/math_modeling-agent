...
- [4. 主成分分析](05-统计分析与数据处理算法说明.md) — PCA降维后可视化聚类
- 逻辑回归 — 聚类是unsupervised vs 逻辑回归是supervised
...
- [5. 因子分析](05-统计分析与数据处理算法说明.md) — PCA vs FA区别
- [2. 聚类分析](05-统计分析与数据处理算法说明.md) — PCA降维+聚类是经典pipeline
...
- [4. 主成分分析](05-统计分析与数据处理算法说明.md) — 对比PCA和FA的理论差异
- 回归分析 — 因子得分可用于回归

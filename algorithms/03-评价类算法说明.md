...
- [2. 模糊层次分析法](03-评价类算法说明.md) — Fuzzy-AHP是AHP的模糊扩展
- [3. 熵权法](03-评价类算法说明.md) — AHP主观 vs 熵权法客观
- [4. 优劣解距离法 (TOPSIS)](03-评价类算法说明.md) — AHP求权重, TOPSIS求排序
...
- [1. 层次分析法](03-评价类算法说明.md) — AHP的模糊化版本
- 模糊综合评价 — 同属模糊决策方法
...
- [1. 层次分析法](03-评价类算法说明.md) — 对比主观vs客观赋权
- [4. 优劣解距离法 (TOPSIS)](03-评价类算法说明.md) — 熵权法常与TOPSIS组合使用
- [7. 变异系数法](03-评价类算法说明.md) — 同属客观赋权方法
...
- [4. 优劣解距离法 (TOPSIS)](03-评价类算法说明.md) — GRA和TOPSIS都是多属性决策
- [1. 层次分析法](03-评价类算法说明.md) — GRA也可用于确定权重
...
- [4. 优劣解距离法 (TOPSIS)](03-评价类算法说明.md) — RSR和TOPSIS都是综合评价方法
- [3. 熵权法](03-评价类算法说明.md) — RSR可与熵权法结合
...
- [3. 熵权法](03-评价类算法说明.md) — 同属客观赋权
- [1. 层次分析法](03-评价类算法说明.md) — 对比客观vs主观赋权
...
- [1. 线性规划](01-优化算法说明.md) — DEA基于LP的投入产出效率
- [4. 优劣解距离法 (TOPSIS)](03-评价类算法说明.md) — DEA和TOPSIS都是多指标评价

...
**交叉引用**:
- [决策树](04-图论与网络分析算法说明.md) — 随机森林的基学习器是决策树
- [XGBoost](02-预测类算法说明.md) — 对比 Bagging (RF) vs Boosting (XGBoost)
- [回归分析](05-统计分析与数据处理算法说明.md) — RF 的回归和特征重要性应用
- [支持向量机](02-预测类算法说明.md) — 集成学习 vs 核方法对比
...
**交叉引用**:
- [随机森林](07-机器学习算法说明.md) — 同为集成学习，对比 Bagging vs Boosting
- [支持向量机](02-预测类算法说明.md) — 另一种分类方法
- [逻辑回归](05-统计分析与数据处理算法说明.md) — 对比不同分类器
...
**交叉引用**:
- [聚类分析](05-统计分析与数据处理算法说明.md) — 孤立森林常用于异常检测（类似聚类中的离群检测）
- [支持向量机](02-预测类算法说明.md) — One-Class SVM 是另一种异常检测方法
- [随机森林](07-机器学习算法说明.md) — 随机森林也可用于异常评分（基于 proximity）

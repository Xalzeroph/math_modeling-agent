...
<!-- EVOLVED: verified 2026-05-10 linprog -->
...
- [2. 整数规划](01-优化算法说明.md) — IP是LP的离散扩展
- [14. 多目标优化](01-优化算法说明.md) — LP可扩展为多目标线性规划
...
- [1. 线性规划](01-优化算法说明.md) — LP是IP的松弛形式
- [3. 动态规划](01-优化算法说明.md) — 某些IP可用DP求解
...
- [2. 整数规划](01-优化算法说明.md) — DP常用于整数规划问题
- [1. 最短路径问题](04-图论与网络分析算法说明.md) — DP是Dijkstra的泛化
...
- [5. 粒子群优化算法](01-优化算法说明.md) — 同属元启发式，对比探索vs开发
- [6. 模拟退火算法](01-优化算法说明.md) — GA全局搜索 vs SA局部逃逸
- [7. 蚁群算法](01-优化算法说明.md) — 对比群体智能方法
...
- [4. 遗传算法](01-优化算法说明.md) — PSO收敛更快但GA多样性更好
- [6. 模拟退火算法](01-优化算法说明.md) — PSO vs SA 收敛曲线对比
...
- [4. 遗传算法](01-优化算法说明.md) — SA擅长局部逃逸
- [1. 蒙特卡洛模拟](06-综合类算法说明.md) — SA的温度机制基于Metropolis采样
...
- [4. 遗传算法](01-优化算法说明.md) — ACO适合离散路径, GA更通用
- [1. 最短路径问题](04-图论与网络分析算法说明.md) — ACO天然适合TSP等路径问题
...
- [4. 遗传算法](01-优化算法说明.md) — DE类似GA但变异策略不同
- [5. 粒子群优化算法](01-优化算法说明.md) — DE和PSO都是连续优化
...
- [6. 模拟退火算法](01-优化算法说明.md) — TS用禁忌表, SA用温度
- [4. 遗传算法](01-优化算法说明.md) — TS是单点搜索 vs GA是种群搜索
...
def grey_wolf_optimizer(objective_func, dim, bounds, n_wolves=30, max_iter=100):
    ...
    for iteration in range(max_iter):
        # 线性衰减系数 a: 2 -> 0
        a = 2.0 * (1 - iteration / max_iter)

        for i in range(n_wolves):
            # 每只狼向 alpha, beta, delta 靠拢
...
- [5. 粒子群优化算法](01-优化算法说明.md) — GWO和PSO同属群体智能
- [4. 遗传算法](01-优化算法说明.md) — 对比GWO的层级领导 vs GA的适者生存
...
def immune_algorithm(objective_func, dim, bounds, n_antibodies=50,
    ...
    for iteration in range(max_iter):
        ...
        # 免疫抑制（去除相似抗体 — 基于欧氏距离去重）
        clones_arr = np.array(clones)
        keep = [0]
        for i in range(1, len(clones_arr)):
            if np.min(np.linalg.norm(clones_arr[i] - clones_arr[keep], axis=1)) > 0.1:
                keep.append(i)
        antibodies = clones_arr[keep][:pop_size]
...
- [4. 遗传算法](01-优化算法说明.md) — IA在GA基础上增加免疫记忆
- [2. 聚类分析](05-统计分析与数据处理算法说明.md) — IA的免疫抑制类似聚类去重
...
- [5. 粒子群优化算法](01-优化算法说明.md) — WOA和PSO都是连续优化元启发式
- [10. 灰狼优化算法](01-优化算法说明.md) — 对比捕食搜索策略
...
- [5. 粒子群优化算法](01-优化算法说明.md) — SSA是较新的群体智能算法
- [4. 遗传算法](01-优化算法说明.md) — SSA有预警者机制, GA有变异
...
- [1. 线性规划](01-优化算法说明.md) — 多目标LP是基础
- [4. 遗传算法](01-优化算法说明.md) — NSGA-II是MOO的经典方法
